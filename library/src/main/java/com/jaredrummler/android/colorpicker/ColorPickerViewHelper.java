...
public class ColorPickerViewHelper implements ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    /**
     * Create a new Builder for creating a {@link ColorPickerViewHelper} instance
     *
     * @return The {@link Builder builder} to create the {@link ColorPickerViewHelper}.
     */
    ...
    public void onCreateDialog(Bundle savedInstanceState) {
        ...
        topView = (LinearLayout) LayoutInflater.from(requireActivity()).inflate(R.layout.cpv_dialog_custom_view, null, false);
        rootView = topView.findViewById(R.id.rootView);
        ...
        getPositiveButton().setText(selectedButtonStringRes);

        int dialogTitleStringRes = getArguments().getInt(ARG_DIALOG_TITLE);
        if (dialogTitleStringRes != 0) {
            getDialogTitle().setText(dialogTitleStringRes);
        }
        ...
        if (neutralButtonStringRes != 0) {
            getNeutralButton().setText(neutralButtonStringRes);
        }
    ...
    public TextView getDialogTitle() {
        return topView.findViewById(R.id.alertTitle);
    }

    public Button getNeutralButton() {
        return topView.findViewById(R.id.button1);
    }


    public Button getPositiveButton() {
        return topView.findViewById(R.id.button2);
    }
...
//        dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
        ...
        getNeutralButton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    View createPickerView() {
        View contentView = View.inflate(requireActivity(), R.layout.cpv_dialog_color_picker, null);
    ...
    View createPresetsView() {
        View contentView = View.inflate(requireActivity(), R.layout.cpv_dialog_presets, null);
        ...
        adapter = new ColorPaletteAdapter(new ColorPaletteAdapter.OnColorSelectedListener() {
            ...
            public void onColorSelected(int newColor) {
                if (color == newColor) {
                    ...
                    ColorPickerViewHelper.this.onColorSelected(color);
                    dismiss();
                    return;
                }
                color = newColor;
    ...
    void createColorShades(@ColorInt final int color) {
        ...
        final int horizontalPadding = requireActivity().getResources().getDimensionPixelSize(R.dimen.cpv_item_horizontal_padding);
        ...
        for (final int colorShade : colorShades) {
            ...
            final View view = View.inflate(requireActivity(), layoutResId, null);
            ...
            colorPanelView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getTag() instanceof Boolean && (Boolean) v.getTag()) {
                        onColorSelected(ColorPickerViewHelper.this.color);
                        dismiss();
                        return; // already selected
                    }
                    ColorPickerViewHelper.this.color = colorPanelView.getColor();
                    adapter.selectNone();
                    for (int i = 0; i < shadesLayout.getChildCount(); i++) {
                        FrameLayout layout = (FrameLayout) shadesLayout.getChildAt(i);
    ...
    public static final class Builder {
         ...
         *
         * @param dialogType Either {@link ColorPickerViewHelper#TYPE_CUSTOM} or {@link ColorPickerViewHelper#TYPE_PRESETS}.
         * @return This builder object for chaining method calls
         */
        ...
        /**
         * Create the {@link ColorPickerViewHelper} instance.
         *
         * @return A new {@link ColorPickerViewHelper}.
         */
        public ColorPickerViewHelper create() {
            ColorPickerViewHelper dialog = new ColorPickerViewHelper();
        ...
        public ColorPickerViewHelper attach(Context context, ViewGroup root) {
            return create().attach(context, root);
        }
    }
    ...
    public ColorPickerViewHelper attach(Context context, ViewGroup baseView) {
